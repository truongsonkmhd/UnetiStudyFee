...
const CourseGuideView: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Tab Switcher */}
      <div className="grid grid-cols-2 md:flex md:flex-wrap gap-2 p-1.5 bg-muted/40 rounded-2xl w-full md:w-fit">
        {TABS.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={`
                flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl text-sm font-black transition-all duration-300
                flex-1 md:min-w-[140px]
                ${isActive 
